...
#SBATCH --job-name=540_$1_Train_nnUNet # job name
...
#SBATCH -e Train_$1_540_nnUNet-%j.err
#SBATCH -o Train_$1_540_nnUNet-%j.out
...
export nnUNet_raw_data_base="/scratch.global/lundq163/nnUNet_HBCD/nnUNet_raw_data_base/"
export nnUNet_preprocessed="/scratch.global/lundq163/nnUNet_HBCD/nnUNet_raw_data_base/nnUNet_preprocessed/"
export RESULTS_FOLDER="/home/feczk001/shared/data/nnUNet/nnUNet_raw_data_base/nnUNet_trained_models"

nnUNet_train 3d_fullres nnUNetTrainerV2_noMirroring 540 $1 $3
EOT
