...
ground_truth_filename = os.path.join(home, 'nnUNet_raw_data_base/nnUNet_raw_data/Task102_BabiesSubset/test/labelsTest/', '00-02mos_Template05.nii.gz')
...
print('dice:', dice_coef(gt_data, predictions_data))
