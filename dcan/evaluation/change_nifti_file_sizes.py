...
os.system('flirt -applyisoxfm 1 -init "$FSLDIR/etc/flirtsch/ident.mat" -in 0mo_template_19.nii.gz -ref 1mo_sub-439083.nii.gz -out 0mo_template_19_resized.nii.gz -interp nearestneighbour')
