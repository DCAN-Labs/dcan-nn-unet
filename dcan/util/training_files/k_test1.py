...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(255, 127, 127)")
        ...
        self.line_slurm_scripts_path.setGeometry(QtCore.QRect(10,477, 665,25))
        ...
        self.label_slurm_scripts_path.setGeometry(QtCore.QRect(10, 457, 500, 15))
        ...
        self.line_raw_data_base_path.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_dcan_path.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_distribution.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_modality.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_slurm_scripts_path.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_synth_img_amt.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_synth_path.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_task_path.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_task_number.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_remove_preset.setStyleSheet("background-color: rgb(255, 255, 255)")
        self.line_save_preset.setStyleSheet("background-color: rgb(255, 255, 255)")
